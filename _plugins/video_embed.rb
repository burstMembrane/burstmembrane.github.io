...
module Jekyll
    class VideoEmbed < Liquid::Tag
        ...
        "vimeo"   => ->(id) { "https://player.vimeo.com/video/#{id}?title=0&byline=0&portrait=0" },
        ...
        def render(context)
        "<div class='video-container'><iframe width=\"#{@width}\" height=\"#{@height}\" src=\"#{@host.call(@id)}\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>"
        end
